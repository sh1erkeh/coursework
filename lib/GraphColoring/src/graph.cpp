...
Graph::Graph(size_t numberOfVertices,
    ...
    std::ranges::copy(adjacencyList.begin(), adjacencyList.end(),
                      std::back_inserter(this->adjacencyList));
}
...
void Graph::addEdge(size_t from, size_t to) { adjacencyList[from].insert(to); }
